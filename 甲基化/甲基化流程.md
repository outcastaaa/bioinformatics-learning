...
```bash
mkdir /mnt/d/mrthylation/output/fastqc
cd /mnt/d/mrthylation/data/sequence

# quality control to see the quality of the raw seq-data
fastqc -t 3 /mnt/d/mrthylation/data/sequence/*.fastq.gz -o /mnt/d/mrthylation/output/fastqc

# 整合质控结果
cd /mnt/d/mrthylation/output/fastqc
multiqc .
```
```bash
...
trim_galore -o /mnt/d/mrthylation/output/adapter/ --fastqc /mnt/d/mrthylation/data/sequence/*.fastq.gz

# 整合质控结果
cd /mnt/d/mrthylation/output/adapter
multiqc .
```
